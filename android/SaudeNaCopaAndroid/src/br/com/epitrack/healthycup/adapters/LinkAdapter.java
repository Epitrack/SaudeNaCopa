...
public class LinkAdapter extends BaseExpandableListAdapter {
	...
	public LinkAdapter(Context context, List<String> listDataHeader, HashMap<String, List<NameValuePair>> listDataChild, int corTexto) {
	...
	public LinkAdapter(Context context, List<String> listDataHeader, HashMap<String, List<NameValuePair>> listDataChild, int corTexto, int corTitulo) {
		this._context = context;
		this._listDataHeader = listDataHeader;
		this._listDataChild = listDataChild;
		this.corTexto = corTexto;
	...
	public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.list_consulado_item, null);
		}

		TextView txtListChild = (TextView) convertView.findViewById(R.id.lblListItem);
		txtListChild.setTextColor(_context.getResources().getColor(corTexto));
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = infalInflater.inflate(R.layout.list_consulado_group, null);
		}
