...
<head>
    ...
    <meta property='og:url' content='http://www.saudenacopa.com' />
    <meta property='og:image' content='http://www.saudenacopa.com/dashboard/site/dist/images/facebook.png'/>
    ...
    <script>
        ...
        ga('create', 'UA-50378086-3', 'http://www.saudenacopa.com/dashboard/site/');
        ga('send', 'pageview');
    </script>
</head>