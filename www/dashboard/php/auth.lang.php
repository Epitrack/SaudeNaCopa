...
// Current Languages : br / en / fr
// ---------------------------

//br (portugues):

$lang['br']['auth']['login_lockedout'] = "Você está temporariamente bloqueado!";
$lang['br']['auth']['login_wait30'] = "Por favor espere 30 minutos.";
$lang['br']['auth']['login_username_empty'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_username_short'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_username_long'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_password_empty'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_password_short'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_password_long'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_incorrect'] = "Usuário / Senha invalidos !";
$lang['br']['auth']['login_attempts_remaining'] = "%d tentativas restantes !";
$lang['br']['auth']['login_account_inactive'] = "A conta não está ativa !";
$lang['br']['auth']['login_success'] = "Você está logado !";
$lang['br']['auth']['login_already'] = "você já está logado !";
$lang['br']['auth']['ponto_monitoramento_vazio'] = "Ponto de Monitoramento invalido !";

$lang['br']['auth']['register_username_empty'] = "Campo de usuário está vazio !";
$lang['br']['auth']['register_username_short'] = "O nome do usuário é pequeno !";
$lang['br']['auth']['register_username_long'] = "O nome do usuário é grande !";
$lang['br']['auth']['register_password_empty'] = "Campo de senha está vazio !";
$lang['br']['auth']['register_password_short'] = "A senha é pequeno !";
$lang['br']['auth']['register_password_long'] = "A senha é grande !";
$lang['br']['auth']['register_password_nomatch'] = "A senha está incorreta !";
$lang['br']['auth']['register_password_username'] = "A senha não pode conter o nome do usuário !";
$lang['br']['auth']['register_email_empty'] = "O campo de e-mail está vazio !";
$lang['br']['auth']['register_email_short'] = "O Email do usuário é pequeno !";
$lang['br']['auth']['register_email_long'] = "O Email do usuário é grande !";
$lang['br']['auth']['register_email_invalid'] = "O Email é invalido !";
$lang['br']['auth']['register_username_exist'] = "O nome do usuário já está em uso !";
$lang['br']['auth']['register_email_exist'] = "Email is already in use !";
$lang['br']['auth']['register_success'] = "New Account Created ! Activation email sent to your email address.";
$lang['br']['auth']['register_email_loggedin'] = "You are currently logged in !";

$lang['br']['auth']['deletesession_invalid'] = "Invalid Session Hash !";

$lang['br']['auth']['sessioninfo_invalid'] = "Invalid Session Hash !";

$lang['br']['auth']['activate_username_empty'] = "Invalid URL !";
$lang['br']['auth']['activate_username_short'] = "Invalid URL !";
$lang['br']['auth']['activate_username_long'] = "Invalid URL !";
$lang['br']['auth']['activate_key_empty'] = "Invalid URL !";
$lang['br']['auth']['activate_key_short'] = "Invalid URL !";
$lang['br']['auth']['activate_key_long'] = "Invalid URL !";
$lang['br']['auth']['activate_username_incorrect'] = "Username is incorrect !";
$lang['br']['auth']['activate_account_activated'] = "Account is already activated !";
$lang['br']['auth']['activate_success'] = "Account successfully activated !";
$lang['br']['auth']['activate_key_incorrect'] = "Activation key is incorrect !";

$lang['br']['auth']['changepass_username_empty'] = "Error encountered !";
$lang['br']['auth']['changepass_username_short'] = "Error encountered !";
$lang['br']['auth']['changepass_username_long'] = "Error encountered !";
$lang['br']['auth']['changepass_currpass_empty'] = "Current Password field is empty !";
$lang['br']['auth']['changepass_currpass_short'] = "Current Password is too short !";
$lang['br']['auth']['changepass_currpass_long'] = "Current Password is too long !";
$lang['br']['auth']['changepass_newpass_empty'] = "New Password field is empty !";
$lang['br']['auth']['changepass_newpass_short'] = "New Password is too short !";
$lang['br']['auth']['changepass_newpass_long'] = "New Password is too long !";
$lang['br']['auth']['changepass_password_username'] = "Password cannot contain the username !";
$lang['br']['auth']['changepass_password_nomatch'] = "Passwords don't match !";
$lang['br']['auth']['changepass_username_incorrect'] = "Error encountered !";
$lang['br']['auth']['changepass_success'] = "Password successfully changed !";
$lang['br']['auth']['changepass_currpass_incorrect'] = "Current Password is incorrect !";

$lang['br']['auth']['changeemail_username_empty'] = "Error encountered !";
$lang['br']['auth']['changeemail_username_short'] = "Error encountered !";
$lang['br']['auth']['changeemail_username_long'] = "Error encountered !";
$lang['br']['auth']['changeemail_email_empty'] = "Email field is empty !";
$lang['br']['auth']['changeemail_email_short'] = "Email is too short !";
$lang['br']['auth']['changeemail_email_long'] = "Email is too long !";
$lang['br']['auth']['changeemail_email_invalid'] = "Email is invalid !";
$lang['br']['auth']['changeemail_username_incorrect'] = "Error encountered !";
$lang['br']['auth']['changeemail_email_match'] = "New email address matches the existing one !";
$lang['br']['auth']['changeemail_success'] = "Email address successfully changed !";

$lang['br']['auth']['resetpass_lockedout'] = "You have been temporarily locked out !";
$lang['br']['auth']['resetpass_wait30'] = "Please wait 30 mins.";
$lang['br']['auth']['resetpass_email_empty'] = "Email field is empty !";
$lang['br']['auth']['resetpass_email_short'] = "Email is too short !";
$lang['br']['auth']['resetpass_email_long'] = "Email is too long !";
$lang['br']['auth']['resetpass_email_invalid'] = "Email is invalid !";
$lang['br']['auth']['resetpass_email_incorrect'] = "Email is incorrect !";
$lang['br']['auth']['resetpass_attempts_remaining'] = "%d attempts remaining !";
$lang['br']['auth']['resetpass_email_sent'] = "Password Reset Request sent to your email address !";
$lang['br']['auth']['resetpass_key_empty'] = "Reset Key field is empty !";
$lang['br']['auth']['resetpass_key_short'] = "Reset Key is too short !";
$lang['br']['auth']['resetpass_key_long'] = "Reset Key is too long !";
$lang['br']['auth']['resetpass_newpass_empty'] = "New Password field is empty !";
$lang['br']['auth']['resetpass_newpass_short'] = "New Password is too short !";
$lang['br']['auth']['resetpass_newpass_long'] = "New Password is too long !";
$lang['br']['auth']['resetpass_newpass_username'] = "New Password cannot contain username !";
$lang['br']['auth']['resetpass_newpass_nomatch'] = "Passwords don't match !";
$lang['br']['auth']['resetpass_username_incorrect'] = "Error encountered !";
$lang['br']['auth']['resetpass_success'] = "Password successfully changed !";
$lang['br']['auth']['resetpass_key_incorrect'] = "Reset Key is incorrect !";

$lang['br']['auth']['checkresetkey_username_incorrect'] = "Username is incorrect !";
$lang['br']['auth']['checkresetkey_key_incorrect'] = "Reset Key is incorrect !";
$lang['br']['auth']['checkresetkey_lockedout'] = "You have been temporarily locked out !";
$lang['br']['auth']['checkresetkey_wait30'] = "Please wait 30 mins.";
$lang['br']['auth']['checkresetkey_attempts_remaining'] = "%d attempts remaining !";

$lang['br']['auth']['deleteaccount_username_empty'] = "Error encountered !";
$lang['br']['auth']['deleteaccount_username_short'] = "Error encountered !";
$lang['br']['auth']['deleteaccount_username_long'] = "Error encountered !";
$lang['br']['auth']['deleteaccount_password_empty'] = "Password field is empty !";
$lang['br']['auth']['deleteaccount_password_short'] = "Password is too short !";
$lang['br']['auth']['deleteaccount_password_long'] = "Password is too long !";
$lang['br']['auth']['deleteaccount_username_incorrect'] = "Error encountered !";
$lang['br']['auth']['deleteaccount_success'] = "Account deleted successfully !";
$lang['br']['auth']['deleteaccount_password_incorrect'] = "Password is incorrect !";

$lang['br']['auth']['logactivity_username_short'] = "Error encountered !";
$lang['br']['auth']['logactivity_username_long'] = "Error encountered !";
$lang['br']['auth']['logactivity_action_empty'] = "Error encountered !";
$lang['br']['auth']['logactivity_action_short'] = "Error encountered !";
$lang['br']['auth']['logactivity_action_long'] = "Error encountered !";
$lang['br']['auth']['logactivity_addinfo_long'] = "Error encountered !";
...
$lang['en']['auth']['ponto_monitoramento_vazio'] = "Ponto de Monitoramento invalid !";
