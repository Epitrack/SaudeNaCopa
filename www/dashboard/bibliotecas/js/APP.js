 ...
 * Bruno Mota, Brenda, Ciclone, Pablo, Leonardo, Ricardo, Júlio Melo, Klayton, César Martins
 **/
...
APP.iniciar = function(Modulos) {
	...
	//var totalAssistencia = $("#totalAssistencia").val();
	//var totalVigilancia = $("#totalVigilancia").val();
	//var totalSurto = $("#totalSurto").val();
	
	//if(totalAssistencia == 0 && totalVigilancia == 0 && totalSurto == 0){
...
APP.mostrarErro = function (valor){
	if(valor){
		console.debug("aqui");
		$("#error").show();
	}
...
APP.apagarErro = function (){
	$("#error").hide();
}
//funcao que deixa escrever apenas numeros
function apenasNumeros(e){
	console.debug(e);
	var nKeyCode = e.keyCode;
	if(e.shiftKey && nKeyCode == 186){
		//e.preventDefault();
	}else{
